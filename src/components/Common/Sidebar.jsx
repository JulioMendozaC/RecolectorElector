...
import { LogOut, MoreHorizontal, Settings, Users, UserPlus, MapPinned } from 'lucide-react';
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-col gap-1 w-full">
            <Link to={'/Colaboradores'}>
              <ButtonSide text={'Colaboradores'} className='w-full'icon={Users} />
            </Link>
          </div>
          <div className="flex flex-col gap-1 w-full">
            <Link to={'/Promovido'}>
              <ButtonSide text={'Promovidos'} className='w-full'icon={Users} />
            </Link>
          </div>
          <div className="flex flex-col gap-1 w-full">
            <Link to={'/Secciones'}>
          ...
          <div className="absolute left-0 bottom-3 w-full px-3">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant='ghost' className='w-full justify-start'>                    <div className='flex justify-between items-center w-full'>
