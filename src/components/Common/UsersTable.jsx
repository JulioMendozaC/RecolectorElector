...
import { UsersForm } from "../Content/UsersForm"
...
export const UserTable = ({ data, columns }) => {
    ...
    const { DeleteUser, response } = useAuth()
            ...
            <AlertDialog>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => DeleteUser(dataEdit)}>Eliminar</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
        </div>
