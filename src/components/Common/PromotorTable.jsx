...
import { PromotorFrrom } from "../Content/PromotorFrrom"
...
export const PromotorTable = ({ data, columns }) => {
    ...
    const { DeleteData, response } = usePromotor()
                    ...
                    <Form>
                        {
                            dataEdit == [] ?
                                <PromotorFrrom />
                                :
                                <PromotorFrrom dataEdit={dataEdit} />
                        }
                    </Form>
                    <DialogFooter>
                    </DialogFooter>
